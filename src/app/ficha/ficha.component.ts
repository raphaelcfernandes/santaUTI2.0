...
export class FichaComponent implements OnInit {
			...
			if(this.fichaObject.Respiratorio.UsoOxigenio === 'Não')
				...
				Object.keys(this.fichaObject.Respiratorio.UsoOxigenio).forEach(item=>{
					...
					if(item === 'Sob Cateter Nasal' || item === 'Em Máscara de Reinalação')
						this.respiratorioString+= item.toLowerCase() + ' com fluxo de '+ this.fichaObject.Respiratorio.UsoOxigenio[item] + ' L/min.';
				});
	...
	private hemodinamicamente() { 
		...
		+ this.fichaObject.MonitorMultiparametrico.ritmo.toLowerCase() + ', FC ' + this.fichaObject.MonitorMultiparametrico.frequenciaCardiaca ; 
	}
